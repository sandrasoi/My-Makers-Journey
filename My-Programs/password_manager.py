...
class PasswordManager():
    ...
    def get_for_service(self, service_name):
        if self.dict.get(service_name):
            return self.dict.get(service_name)
...
#password_manager = PasswordManager()
#print(password_manager.dict)
#password_manager.add('gmail', '12ab5!678')
#password_manager.add('facebook', '$abc1234')
#password_manager.add('facebook1', '')
#password_manager.add('service_1', '1234567')
