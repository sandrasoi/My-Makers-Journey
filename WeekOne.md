...
To test my knowledge, I completed a simple challenge to validate a password by using if statements to check its length and whether it contains certain characters by making a [password validator program. ](https://github.com/sandrasoi/My-Makers-Journey/blob/main/My-Programs/password_validator.py)https://github.com/sandrasoi/My-Makers-Journey/blob/main/My-Programs/password_validator.py
